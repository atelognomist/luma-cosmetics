...
import { DEMO_ORDERS, STATUS_LABELS, formatPrice, formatDate, orderTotal, type OrderStatus } from "@/lib/data";
...
export default function OrderDetail() {
  ...
  function handleCallSubmit() {
    ...
    if (callOutcome === "confirmed") setLocalStatus("confirmed");
    if (callOutcome === "rejected") setLocalStatus("rejected");
    if (callOutcome === "no_answer") setLocalStatus("no_answer");
  ...
  function advanceStatus() {
    ...
    if (flow[status]) setLocalStatus(flow[status]!);
  }

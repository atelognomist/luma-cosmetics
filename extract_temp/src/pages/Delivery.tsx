...
import { DEMO_AGENCIES, DEMO_ORDERS } from "@/lib/data";
import StatusBadge from "@/components/ui/StatusBadge";

export default function Delivery() {
  const [activeAgency, setActiveAgency] = useState<string | null>(null);
  const agency = activeAgency ? DEMO_AGENCIES.find((a) => a.id === activeAgency) : null;

  const inTransitOrders = DEMO_ORDERS.filter((o) =>
              ...
              <tbody>
                {DEMO_AGENCIES.map((a, i) => (
                  <tr
                    ...
                    style={{ borderBottom: i < DEMO_AGENCIES.length - 1 ? "1px solid var(--border)" : undefined }}
                  >

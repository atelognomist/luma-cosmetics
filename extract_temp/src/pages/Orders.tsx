...
import { DEMO_ORDERS, STATUS_LABELS, formatPrice, relativeTime, orderTotal, type OrderStatus } from "@/lib/data";
...
export default function Orders() {
  ...
  function tabCount(t: Tab) {
    return DEMO_ORDERS.filter((o) => matchTab(o.status, t)).length;
  }
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs font-mono px-2 py-1 rounded" style={{ backgroundColor: "var(--secondary)", color: "var(--muted-foreground)" }}>
            {DEMO_ORDERS.length} commandes · Données démo
          </span>
        </div>

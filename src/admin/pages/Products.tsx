                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex flex-wrap gap-1">
                      <Flag label="Meilleure vente" active={p.flags?.bestSeller || false} />
                      <Flag label="Nouveau" active={p.flags?.newArrival || false} />
                      <Flag label="Vedette" active={p.flags?.featured || false} />
                      <Flag label="Promo" active={p.flags?.onSale || false} />
                    </div>
                  </td>
                  <td className="px-4 py-3">
                    <button
